...
public class CameraActivity extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button okButton = (Button) findViewById(getResources().getIdentifier("okButton", "id", getPackageName()));
        final Button cancelButton = (Button) findViewById(getResources().getIdentifier("cancelButton", "id", getPackageName()));
        ...
        captureButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE == getDefaultOrientation()) {
                    if(degrees > 0) {
                        degrees = degrees - 90;
                    } else {
                        degrees = 360 - 90;
